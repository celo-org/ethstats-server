(function() {
  ...
  if ($("body").width() < 600) $.fn.sparkline.defaults.bar.barWidth = 4;
  else if ($("body").width() < 1200) $.fn.sparkline.defaults.bar.barWidth = 5;
  ...
  $.fn.sparkline.defaults.bar.tooltipFormat = $.spformat(
    '<div class="tooltip-arrow"></div><div class="tooltip-inner">{{prefix}}{{value}} {{suffix}}</div>'
  );
